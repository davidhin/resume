...
\cveventalt{Supervision of summer projects}{The University of Adelaide}{Nov 2020 -- Feb 2021}{Python, React, Express, Node.js, Google Cloud Platform}
\begin{itemize}
...
\cveventalt{Development of web application for tracking of vulnerable software components}{The University of Adelaide}{Mar 2020 -- Nov 2020}{React, Node.js, Express, MongoDB, Google Cloud Platform, Docker, HTML5/CSS3}
\begin{itemize}
...
\cveventalt{Development of security-related text classifier from online discussions}{Centre for Research on Software Engineering Technologies}{Oct 2019 -- Jan 2020}{Python, Scikit-Learn, Docker}
\begin{itemize}
...
\item Awarded \$10,000 by the Cybersecurity Cooperative Research Centre.
\item Le, T.H., \yearbold{Hin, D.}, Croft, R. and Babar, M.A., 2020. PUMiner: Mining Security Posts from Developer Question and Answer Websites with PU Learning. In \textit{2020 IEEE/ACM 17th International Conference on Mining Software Repositories (MSR). IEEE.} (CORE A).
\end{itemize}
\divider
...
\cveventalt{Exploration of deep style transfer in images}{The University of Adelaide}{Dec 2018 -- Jan 2019}{Python, Matlab}
\begin{itemize}
...
\item Alexander, B., \yearbold{Hin, D.}, Neumann, A. and Ull-Karim, S., 2019, December. \textit{Evolving pictures in image transition space. In International Conference on Neural Information Processing (pp. 679-690). Springer, Cham.} (CORE B)
\end{itemize}

\switchcolumn

\cvsection{Summary}
I am an experienced data scientist with a strong foundation in software engineering principles. My projects
address real-world problems across areas as diverse as software security, biology, and computer vision. They
demonstrate my expertise in software development, encompassing web, mobile, and desktop-based
applications. Many of these projects have been published in peer-reviewed literature, highlighting my ability to
see projects to completion while working with different teams. I am seeking an opportunity where I can
continually improve my engineering practices and find new ways to optimise complex tasks
